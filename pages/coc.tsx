            ...
            <div className="w-4/5 md:w-3/5 my-16">
                ...
                <ul className="list-disc list-inside ml-3 mb-10">
                    ...
                    <li>
                        ...
                        physical or electronic address, without explicit
                        permission
                    </li>
                    <li>
                ...
                <TextHeader text="our responsibilities" />
                <p className="py-4 mb-6">
                ...
                <p className="py-4 mb-6">
                    ...
                    enforcement policies may be posted separately. Project
                    maintainers who do not follow or enforce the Code of Conduct
                    in good faith may face temporary or permanent repercussions
                    as determined by other members of the project's leadership.
                </p>
                <TextHeader text="attribution" />
                <p className="py-4">
